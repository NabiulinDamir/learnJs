...
var VERSION = /* @__PURE__ */ new Version("20.3.1");
...
// src/app/servises/theme.service.ts
var Theme = class _Theme {
  document;
  darkTheme = signal(false, ...ngDevMode ? [{ debugName: "darkTheme" }] : []);
  ...
  static \u0275fac = function Theme_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Theme)(\u0275\u0275inject(DOCUMENT));
  };
...
var localDB = class _localDB {
  ...
  getAll(storeKey) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve, reject) => {
  ...
  getByKey(storeKey, itemKey) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve, reject) => {
        const request = store2.get(itemKey);
        request.onsuccess = () => resolve(request.result);
        request.onerror = () => reject(request.error);
      });
    });
  ...
  add(storeKey, object) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve, reject) => {
        const request = store2.add(object);
        request.onsuccess = () => {
  ...
  setByObject(storeKey, newObj) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve, reject) => {
        const request = store2.put(newObj);
        request.onsuccess = () => resolve(request.result);
        request.onerror = () => reject(request.error);
      });
    });
  ...
  deleteByKey(storeKey, itemKey) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve, reject) => {
        const request = store2.delete(itemKey);
        request.onsuccess = () => resolve(request.result);
        request.onerror = () => reject(request.error);
      });
    });
  ...
  keyOf(storeKey, itemKey) {
    return __async(this, null, function* () {
      ...
      const store2 = transaction.objectStore(storeKey);
      return new Promise((resolve) => {
        const request = store2.getKey(itemKey);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4AIEVVNH.js.map
